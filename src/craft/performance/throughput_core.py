    ...
    def get_memory_stats(self) -> Dict[str, float]:
        ...
        if torch.cuda.is_available():
            ...
            try:
                ...
                stats['allocated'] = memory_info.rss / (1024 * 1024)  # RSS in MB
                stats['reserved'] = memory_info.vms / (1024 * 1024)  # VMS in MB
                stats['peak'] = getattr(process, 'memory_peak', lambda: 0)() / (1024 * 1024)
            except ImportError:
