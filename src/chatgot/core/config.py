...
def load_config(config_name: str = "config", overrides: Optional[list] = None) -> DictConfig:
    ...
    """
    hydra.initialize(version_base=None, config_path=os.path.relpath(CONFIG_PATH))
